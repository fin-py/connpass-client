...
def main(
    event_id: Annotated[
        int, typer.Option(help="イベント毎に割り当てられた番号で検索します。複数指定可能です")
    ] = None,
    keyword: Annotated[
    ...
    ym: Annotated[int, typer.Option(help="指定した年月に開催されているイベントを検索します。複数指定可能です")] = None,
    ymd: Annotated[int, typer.Option(help="指定した年月日に開催されているイベントを検索します。複数指定可能です")] = None,
    nickname: Annotated[
    ...
    series_id: Annotated[
        int, typer.Option(help="グループ 毎に割り当てられた番号で、ひもづいたイベントを検索します。複数指定可能です")
    ] = None,
    start: Annotated[int, typer.Option(help="検索結果の何件目から出力するかを指定します")] = None,
    order: Annotated[int, typer.Option(help="検索結果の表示順を、更新日時順、開催日時順、新着順で指定します")] = None,
    count: Annotated[int, typer.Option(help="検索結果の最大出力データ数を指定します")] = None,
